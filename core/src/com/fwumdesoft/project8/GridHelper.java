...
public class GridHelper {
	 ...
	 * Passing the grid would be redudant because any use of GridFunction will require having the grid, so it can be wrapped in the lambda
	 */
	 ...
	 * @param func The function to apply to each space
	 */
